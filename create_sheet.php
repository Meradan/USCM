...
//   $character = characterdata($characterId);
  ...
  foreach ($attributearray as $attributeid => $attribute) {
    ...
    $attributepointsbonus = $character->attributeBonus("modifier_basic_value", $attributeid);
    ...
    $attributepointsbonus = $character->attributeBonus("modifier_dice_value", $attributeid);
    print_pdf_bonus ( $pdf, $attributepointsbonus );
    $height -= 12;
  }
  ...
  $awarenessbonus = pointandlimitbonus ($characterId, "awareness" );
  ...
  $leadership = leadership($characterId);
  $leadershipbonus = pointandlimitbonus($characterId, "leadership" );
  ...
  $psychopointsbonus = pointandlimitbonus($characterId, 'psychopoints');
  ...
  $fearpointsbonus = pointandlimitbonus($characterId, 'fearpoints');
  ...
  $exhaustionpointsbonus = pointandlimitbonus($characterId, 'exhaustionpoints');
  ...
  pdf_show ( $pdf, carrycapacity($characterId));
  pdf_set_text_pos ( $pdf, $aapcolumnsix, 374 );
  $carrybonus = carrycapacitybonus($characterId);
  ...
  pdf_show ( $pdf, combatload($characterId));
  pdf_set_text_pos ( $pdf, $aapcolumnsix, 362 );
  $combatbonus = combatloadbonus($characterId);
  ...
  pdf_show ( $pdf, psycholimit($characterId));
  pdf_set_text_pos ( $pdf, $aapcolumnsix, 326 );
  $psycholimitbonus = pointandlimitbonus($characterId, 'psycholimit');
  ...
  pdf_show ( $pdf, fearlimit($characterId));
  pdf_set_text_pos ( $pdf, $aapcolumnsix, 314 );
  $fearlimitbonus = pointandlimitbonus($characterId, 'fearlimit');
  ...
  pdf_show ( $pdf, exhaustionlimit($characterId));
  pdf_set_text_pos ( $pdf, $aapcolumnsix, 302 );
  $exhaustionlimitbonus = pointandlimitbonus($characterId, 'exhaustionlimit');
  ...
  fontregular ( $font, $pdf );
  $missionarray = missions($characterId, "short");
  $missionheight -= 12;
  ...
  fontregular ( $font, $pdf );
  $certificatearray = certificates($characterId, $platoon_id );
  ...
  fontregular ( $font, $pdf );
  $advarray = advantages($characterId);
  $advheight -= 12;
  ...
  fontregular ( $font, $pdf );
  $disadvarray = disadvantages($characterId);
  $disadvheight -= 12;
  ...
  pdf_show ( $pdf, "Bonus" );
  fontregular ( $font, $pdf );
  $skillarray = characterskills($characterId, "Weapons", $certificatearray );
  $skillsheight -= 12;
  ...
  $skillsheight -= 12;
  $skillarray = characterskills($characterId, "Physical", $certificatearray );
  foreach ( $skillarray as $skill ) {
    pdf_set_text_pos ( $pdf, 380, $skillsheight );
    pdf_show ( $pdf, $skill ['name'] );
  ...
  $skillsheight -= 12;
  $skillarray = characterskills($characterId, "Vehicles", $certificatearray );
  foreach ( $skillarray as $skill ) {
    pdf_set_text_pos ( $pdf, 380, $skillsheight );
    pdf_show ( $pdf, $skill ['name'] );
  ...
  $skillsheight -= 12;
  $skillarray = characterskills($characterId, "Other", $certificatearray );
  foreach ( $skillarray as $skill ) {
    pdf_set_text_pos ( $pdf, 380, $skillsheight );
    pdf_show ( $pdf, $skill ['name'] );
  ...
  $skillsheight -= 12;
  $skillarray = characterskills($characterId, "Languages", $certificatearray );
  foreach ( $skillarray as $skill ) {
    pdf_set_text_pos ( $pdf, 380, $skillsheight );
    pdf_show ( $pdf, $skill ['name'] );
